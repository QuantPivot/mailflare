...
export default function AccountsPage() {
	...
	return <div className="space-y-6">
		<div className="flex items-center justify-between gap-4"><div><h1 className="text-3xl font-medium text-neutral-900">{t("Accounts")}</h1><p className="mt-2 text-sm text-neutral-500">{t("Manage Team accounts and their inboxes.")}</p></div>{!teamRequired && <Button onClick={() => setCreateOpen(true)}><Plus className="h-4 w-4" />{t("New account")}</Button>}</div>
