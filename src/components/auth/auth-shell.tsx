...
export function AuthShell({
 ...
 const t = useT();
  ...
  return (
    <div className="min-h-dvh bg-auth-background px-4 py-6 text-neutral-900 dark:text-neutral-100 sm:px-6 lg:flex lg:items-center lg:px-10 lg:py-10">
      <main className="mx-auto grid w-full max-w-6xl overflow-hidden rounded-4xl bg-card lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)]">
        <section className="flex flex-col p-7 sm:p-10 lg:p-14">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="ml-auto"><AppearanceControls /></div>
          </div>
          ...
          <div className="mt-2 lg:mt-8">
            ...
            {description && (
              <p className="mt-5 max-w-md text-base leading-7 text-neutral-600 dark:text-neutral-300">
                {description}
              </p>
            )}
          </div>
        ...
        <section className="flex min-w-0 flex-col justify-center p-7 sm:p-10 lg:p-14">
            ...
            <div className="mb-7 flex flex-wrap gap-2 text-xs font-semibold">
              {steps.map((step, index) => (
                <span key={step.label} className="flex items-center gap-2">
                  <span
                    className={
                      step.active ? "text-blue-700 dark:text-blue-300" : "text-neutral-400"
                    }
                  >
          ...
          {footer && (
            <div className="mt-8 text-sm font-medium text-blue-700 dark:text-blue-300">
              {footer}
            </div>
          )}
        </section>
